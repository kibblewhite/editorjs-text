...
class a {
  ...
  _set_wrap_element(t) {
    this._data.wrap = a.SupportedWrapElementsArray.find((e) => e === t) ?? a.DefaultWrapElement;
  }
  _instantiate_data(t) {
    this._data = this.normalizeData(t || {});
  }
  constructor({ data: t, config: e, api: r, readOnly: i }) {
    this.api = r, this.readOnly = i, this._CSS = { block: this.api.styles.block, wrapper: "ce-text" }, this.readOnly || (this.onKeyUp = this.onKeyUp.bind(this), this.onKeyDown = this.onKeyDown.bind(this)), this._placeholder = e.placeholder ? e.placeholder : a.DefaultPlaceHolder, this._data = t ?? {}, this._element = null, this._preserveBlank = e.preserveBlank !== void 0 && e.preserveBlank, this._allowEnterKeyDown = e.allowEnterKeyDown !== void 0 && e.allowEnterKeyDown, this._hidePopoverItem = e.hidePopoverItem !== void 0 && e.hidePopoverItem, this._hideToolbar = e.hideToolbar !== void 0 && e.hideToolbar, this._startMarginZero = e.startMarginZero !== void 0 && e.startMarginZero, this._instantiate_data(t), this._set_wrap_element(e.wrapElement);
  }
  static get toolbox() {
    return this._hidePopoverItem === !0 ? [] : { icon: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 9V7.2C8 7.08954 8.08954 7 8.2 7L12 7M16 9V7.2C16 7.08954 15.9105 7 15.8 7L12 7M12 7L12 17M12 17H10M12 17H14"/></svg>', title: "Text" };
  }
  _currentWrapElement() {
    return a.SupportedWrapElementsArray.find((t) => t.wrap === this._data.wrap).toString() ?? a.DefaultWrapElement;
  }
  normalizeData(t) {
    const e = t && typeof t.text == "string" ? t.text : "", r = t && t.wrap ? t.wrap : a.DefaultWrapElement;
    if (this.redactor) {
      const i = this.redactor.querySelectorAll(".ce-block");
      if (i.length > 1) for (let n = 1; n < i.length; n++) i[n].remove();
    }
    return { text: e, wrap: r };
  }
  onKeyUp(t) {
  ...
  onKeyDown(t) {
    if (this._allowEnterKeyDown === !1 && t.key === "Enter") return this.api.events.emit("block:enter", { element: this._element, event: t }), t.stopPropagation(), !0;
  }
  drawView() {
  ...
  render() {
    return this._element = this.drawView(), setTimeout(() => {
      if (this.holder = this._element.closest(".codex-editor"), this.redactor = this.holder?.querySelector(".codex-editor__redactor"), this._hidePopoverItem === !0) {
        this._hide_element_on_mutation('.ce-popover-item[data-item-name="text"]');
        const t = this.redactor.querySelectorAll(".ce-text.cdx-block");
        for (let e = 1; e < t.length; e++) {
          let r = t[e].closest(".ce-block");
          r && r.remove();
        }
      }
      if (this._hideToolbar === !0 && this._hide_element_on_mutation(".ce-toolbar"), this._startMarginZero === !0) {
        const t = this.redactor.querySelectorAll(".ce-block__content");
        for (let e = 0; e < t.length; e++)
          t[e].style.setProperty("max-width", "100%", "important");
      }
    }, 1), this._element;
  }
  merge(t) {
    let e = { text: this._data.text + t.text, wrap: this._data.wrap };
  ...
  save(t) {
    return { text: t.innerHTML, wrap: this._data.wrap };
  }
  onPaste(t) {
  ...
  get data() {
    if (this._element !== null && this._element !== void 0) {
  ...
  set data(t) {
    this._data = this.normalizeData(t), this._element !== null && this.hydrate();
  }
  hydrate() {
