...
!function(t, e) {
  ...
  class t {
    ...
    constructor({ data: e, config: i, api: a, readOnly: r }) {
      this.api = a, this.readOnly = r, this._CSS = { block: this.api.styles.block, wrapper: "ce-text" }, this.readOnly || (this.onKeyUp = this.onKeyUp.bind(this), this.onKeyDown = this.onKeyDown.bind(this)), this._placeholder = i.placeholder ? i.placeholder : t.DefaultPlaceHolder, this._data = e ?? {}, this._element = null, this._preserveBlank = void 0 !== i.preserveBlank && i.preserveBlank, this._allowEnterKeyDown = void 0 !== i.allowEnterKeyDown && i.allowEnterKeyDown, this._hidePopoverItem = void 0 !== i.hidePopoverItem && i.hidePopoverItem, this._hideToolbar = void 0 !== i.hideToolbar && i.hideToolbar, this._instantiate_data(e), this._set_wrap_element(i.wrapElement);
    }
    static get toolbox() {
    ...
    normalizeData(e) {
      const i = e && "string" == typeof e.text ? e.text : "", a = e && e.wrap ? e.wrap : t.DefaultWrapElement;
      if (this.redactor) {
